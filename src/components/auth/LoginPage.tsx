...
const LoginPage = () => {
  ...
  const handleDemoLogin = (role: 'employee' | 'doctor' | 'insurance') => {
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <button
              ...
              className="text-xs bg-teal-600 text-white px-3 py-2 rounded-lg hover:bg-teal-700 transition-colors"
            >
              Doctor
            </button>
            <button
              onClick={() => handleDemoLogin('insurance')}
