      ...
      <div className="bg-white rounded-xl shadow-sm border">
        ...
        <div className="p-6">
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <button 
              onClick={() => alert('Opening emergency protocols...')}
      ...
      <div className="bg-white rounded-xl shadow-sm border">
        <div className="p-6 border-b border-gray-200">
          <div className="flex justify-between items-center">
            ...
            <button 
              onClick={() => alert('Opening full patient list...')}
              ...
              <div key={patient.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">ID: {patient.id} • Age: {patient.age} • {patient.condition}</p>
                  </div>
                </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border">
        <div className="p-6 border-b border-gray-200">
          <div className="flex justify-between items-center">
            ...
            <button 
              onClick={() => alert('Opening reports management...')}
              className="text-teal-600 hover:text-teal-700 font-medium text-sm flex items-center space-x-1"
            >
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex space-x-2">
                    ...
                    {report.status === 'pending' && (
                      <button 
                        onClick={() => alert(`Editing report ${report.id}...`)}
      ...
      {showPatientDetails && selectedPatient && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200">
              <div className="flex justify-between items-center">
                <h3 className="text-xl font-bold text-gray-900">Patient Details - {selectedPatient.name}</h3>
                <button 
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <p><span className="font-medium">Next Appointment:</span> {selectedPatient.nextAppointment}</p>
              ...
              <div key={patient.id} className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start mb-4">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <span className={`px-3 py-1 text-xs font-medium rounded-full ${
                        patient.status === 'Active Treatment' ? 'bg-green-100 text-green-800' :
                ...
                <div className="grid md:grid-cols-2 gap-4 text-sm mb-4">
                  <div className="space-y-1">
                    <p><span className="font-medium text-gray-700">Insurance ID:</span> {patient.insuranceId}</p>
                    <p><span className="font-medium text-gray-700">Last Visit:</span> {patient.lastVisit}</p>
                    <p><span className="font-medium text-gray-700">Phone:</span> {patient.phone}</p>
                  </div>
                  <div className="space-y-1">
                    <p><span className="font-medium text-gray-700">Condition:</span> {patient.condition}</p>
                    <p><span className="font-medium text-gray-700">Next Appointment:</span> {patient.nextAppointment}</p>
                    <p><span className="font-medium text-gray-700">Email:</span> {patient.email}</p>
                  </div>
                </div>
                ...
                <div className="flex justify-end space-x-3">
                  ...
                  <button 
                    onClick={() => alert(`Creating report for ${patient.name}...`)}
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-xl shadow-sm border p-12 text-center">
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            <p className="text-sm text-gray-600">Report ID: <span className="font-mono font-bold text-teal-600">R{Date.now().toString().slice(-6)}</span></p>
          </div>
          <button
              ...
              <div key={appointment.id} className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-gray-600">{appointment.type} • {appointment.duration}</p>
                  </div>
                  <div className="text-right">
